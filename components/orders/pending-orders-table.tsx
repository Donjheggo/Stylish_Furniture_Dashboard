...
import { GetPendingOrders, GetTotalPendingOrders } from "@/lib/actions/orders";
...
export default async function PendingOrdersTable({
  searchQuery,
  page,
}: {
  searchQuery: string;
  ...
  const [totalOrders, orders] = await Promise.all([
    ...
    GetPendingOrders(searchQuery, page, items_per_page),
  ]);
